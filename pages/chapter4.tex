...
\mlcomment{
  \begin{figure}[h]
    ...
    \begin{subfigure}{0.32\textwidth}
      \begin{minipage}{\linewidth}
        \centerline{\includegraphics[width=0.5\textwidth]{img/real_world/sensors1.png}}
        \vspace{10pt}
        \centerline{\includegraphics[width=0.5\textwidth]{img/real_world/sensors2.png}}
        \vspace{20pt}
      \end{minipage}
      \caption{标定结果可视化}
      \label{fig:sensors}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.94\textwidth}
    \includegraphics[width=0.5\linewidth]{img/real_world/indoor/pointcloud1.png}
    \includegraphics[width=0.5\linewidth]{img/real_world/indoor/pointcloud2.png}
    \caption{室内上色点云地图}
  ...
  \begin{subfigure}{0.94\textwidth}
    \vspace{15pt}
    \includegraphics[width=0.5\linewidth]{img/real_world/outdoor/pointcloud1.png}
    \includegraphics[width=0.5\linewidth]{img/real_world/outdoor/pointcloud2.png}
    \caption{室外上色点云地图}
