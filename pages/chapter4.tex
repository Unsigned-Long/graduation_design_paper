...
\mlcomment{
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
      \includegraphics[width=\linewidth]{img/simu/scene1.png}
      \caption{斜视图}
      \label{fig:simu1}
    \end{subfigure}
    \begin{subfigure}{0.4\textwidth}
      \includegraphics[width=\linewidth]{img/simu/scene2.png}
      \caption{俯视图}
      \label{fig:simu2}
    \end{subfigure}
    % \subfigure[\normf{斜视图}]{
...
\mlcomment{
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
      \includegraphics[width=\linewidth]{img/simu/map.png}
      \caption{带有路标的点云地图}
      \label{fig:simu_map}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
      \includegraphics[width=\linewidth]{img/simu/plane.png}
      \caption{带有路标的平面地图}
...
\mlcomment{
  \begin{figure}[htbp]
    ...
    \centering
    \includegraphics[width=\linewidth]{img/simu/params_iter/abs_error.png}
...
\mlcomment{
  \begin{figure}[h]
    ...
    \begin{subfigure}{0.511\textwidth}
      ...
      \label{fig:equipment}
    \end{subfigure}
    \begin{subfigure}{0.4488\textwidth}
      \begin{minipage}{\linewidth}
...
\mlcomment{
  \begin{figure}[h]
    ...
    \begin{subfigure}{0.25\textwidth}
      \begin{minipage}{\linewidth}
        \centerline{\includegraphics[width=0.6\textwidth]{img/real_world/sensors1.png}}
        \vspace{10pt}
        \centerline{\includegraphics[width=0.4\textwidth]{img/real_world/sensors2.png}}
        \vspace{20pt}
      \end{minipage}
      \caption{标定结果可视化}
      \label{fig:sensors}
...
\mlcomment{
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{img/real_world/indoor/params_iter/abs_error.png}
...
\mlcomment{
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{img/real_world/outdoor/params_iter/abs_error.png}
...
\mlcomment{
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{img/real_world/iter_info.png}

    \caption{\normf{实测实验BO中的目标函数(左)、梯度(中)和置信半径(右)变化曲线}}
...
\mlcomment{
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{\textwidth}
      \includegraphics[width=\linewidth]{img/real_world/indoor/residuals.png}
      \caption{室内实验}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
      \includegraphics[width=\linewidth]{img/real_world/outdoor/residuals.png}
      \caption{室外实验}
    \end{subfigure}
    % \subfigure[\normf{室内实验}]{
    %   \centering
...
\begin{figure}[htbp]
  \centering
  \begin{subfigure}{\textwidth}
    \includegraphics[width=0.497\linewidth]{img/real_world/indoor/pointcloud1.png}
    \includegraphics[width=0.497\linewidth]{img/real_world/indoor/pointcloud2.png}
    \caption{室内上色点云地图}
    \label{fig:indoor_pointcloud}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \vspace{15pt}
    \includegraphics[width=0.245\linewidth]{img/real_world/indoor/image_view1.png}
    \includegraphics[width=0.245\linewidth]{img/real_world/indoor/map_view1.png}
    \includegraphics[width=0.245\linewidth]{img/real_world/indoor/image_view2.png}
    \includegraphics[width=0.245\linewidth]{img/real_world/indoor/map_view2.png}
    \caption{室内共视视角}
  ...
  \begin{subfigure}{\textwidth}
    \vspace{15pt}
    \includegraphics[width=0.497\linewidth]{img/real_world/outdoor/pointcloud1.png}
    \includegraphics[width=0.497\linewidth]{img/real_world/outdoor/pointcloud2.png}
    \caption{室外上色点云地图}
  ...
  \begin{subfigure}{\textwidth}
    \vspace{15pt}
    \includegraphics[width=0.245\linewidth]{img/real_world/outdoor/image_view1.png}
    \includegraphics[width=0.245\linewidth]{img/real_world/outdoor/map_view1.png}
    \includegraphics[width=0.245\linewidth]{img/real_world/outdoor/image_view2.png}
    \includegraphics[width=0.245\linewidth]{img/real_world/outdoor/map_view2.png}
    \caption{室外共视视角}
...
\mlcomment{
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
      \includegraphics[width=\linewidth]{img/simu2/scene1.png}
      \caption{斜视图}
      \label{fig:simu1_1}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
      \includegraphics[width=\linewidth]{img/simu2/scene2.png}
      \caption{俯视图}
      \label{fig:simu2_2}
    \end{subfigure}
    % \subfigure[\normf{斜视图}]{
...
\mlcomment{
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{0.49\textwidth}
      \includegraphics[width=\linewidth]{img/simu2/map.png}
      \caption{带有路标的点云地图}
      \label{fig:simu2_map}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
      \includegraphics[width=\linewidth]{img/simu2/plane.png}
      \caption{带有路标的平面地图}
    ...
    \begin{subfigure}{0.3\textwidth}
      \includegraphics[width=\linewidth]{img/simu2/model.png}
      \caption{多传感器建模实体}
      \label{fig:simu2_model}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
      \includegraphics[width=\linewidth]{img/simu2/calib_result1.png}
      \caption{标定结果(正视图)}
      \label{fig:simu2_calib_result1}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
      \includegraphics[width=\linewidth]{img/simu2/calib_result2.png}
      \caption{标定结果(俯视图)}
...
\mlcomment{
  \begin{figure}[htbp]
    ...
    \centering
    \includegraphics[width=\linewidth]{img/simu2/params_iter/abs_error.png}
...
为了直接通过增量方程的数值表达形式来考察系统的可观性，在每次批处理迭代计算之前，我们基于Ceres的自动求导(Automatic Differentiation)功能，输出损失函数对相关参数的雅克比矩阵，而后构建出增量方程中的矩阵$\boldsymbol{H}_{n\times n}$和向量$\boldsymbol{b}_{n\times 1}$。
...
\mlcomment{
  \begin{figure}[h]
    ...
    %   \label{fig:simu2_lm_equ_2_3}
    % }
    \caption{\normf{随机运动下每次迭代时的增量方程}}
    \label{fig:simu2_lm_equ}
  \end{figure}
}

为了更加直观的展示待求参数的可观性，我们通过等价行变换求解了增量方程的行简化阶梯型。对于随机运动而言，其每次迭代时增量方程的行简化阶梯型如图\ref{fig:simu2_lm_equ_echelon_form}所示。当参数$\delta\boldsymbol{x}(i)$可以被表示为其他参数的线性组合时，表示该参数不可观，反之则可观。注意到，使用该种方式考察参数可观性等价于使用系数矩阵的零空间$N(\boldsymbol{H})$进行参数可观性判断。
\mlcomment{
  \begin{figure}[h]
    \centering
